...
import org.vimox.storm.sentimentanalysis.cameljms.SpringJmsProvider;
...
public final class SentimentAnalysisTopology {
	...
	public static final void main(final String[] args) throws Exception {
		...
		try {
			...
			topologyBuilder.setBolt("jmsBolt", jmsBolt)
					.fieldsGrouping("sentimentcalculatorbolt", new Fields("stateCode"));
